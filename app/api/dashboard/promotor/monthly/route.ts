// VAST FINANCE - Promotor Monthly Dashboard API
// Query agg_monthly_promoter untuk user saat ini
...
export async function GET(request: NextRequest) {
  try {
    ...
    const currentMonth = witaDate.slice(0, 7)
    ...
    console.error('Promotor monthly API error:', error)
