...
import { getCurrentDateWITA, formatDateWITA } from '@/lib/date-utils';
...
export default function StoreDetailPage() {
    ...
    // Filter state - Use WITA for current month
    const now = getCurrentDateWITA();
                        ...
                        <div className="mb-4 bg-card rounded-xl shadow-md max-h-48 overflow-y-auto">
                            {monthOptions.map((option) => (
                                <button
                                    ...
                                    className={`w-full px-4 py-2.5 text-left text-sm transition-colors ${selectedMonth === option.value
