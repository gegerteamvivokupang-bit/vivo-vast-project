// ============================================================================
// GENERATE SQL INSERT dengan MAPPING UUID DARI DATABASE
// ============================================================================

const fs = require('fs');

// Load transformed data
const transformedPath = 'F:\\gpt_crazy_vast\\data\\migration_transformed_final.json';
const transformedData = JSON.parse(fs.readFileSync(transformedPath, 'utf8'));

console.log('='.repeat(80));
console.log('GENERATE SQL INSERT - FINAL VERSION');
console.log('='.repeat(80));
...
-- ============================================================================
-- INSERT DATA DESEMBER 2025 (${stats.success} records)
-- ============================================================================
...
const sqlFilePath = 'F:\\gpt_crazy_vast\\migration_desember2025_FINAL.sql';
...
// Export warnings
if (warnings.length > 0) {
    const warningsPath = 'F:\\gpt_crazy_vast\\migration_warnings.txt';
...
console.log('='.repeat(80));
console.log('\n📋 NEXT STEPS:');
console.log('1. Review file: migration_desember2025_FINAL.sql');
console.log('2. Backup data testing di Supabase');
console.log('3. Hapus data testing');
console.log('4. Execute SQL migration');
console.log('5. Verify hasil dengan query yang sudah disediakan');
