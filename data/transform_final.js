// ============================================================================
// TRANSFORMASI DATA - CEK SATU PER SATU (ROBUST VERSION)
// Cari kolom promotor secara dinamis di setiap row
// ============================================================================
...
desemberData.forEach((row, index) => {
    try {
        // Cari promotor
        const promotorData = findPromotor(row);
        ...
        const promotor = promotorData.value;
        const promotorColumn = promotorData.column;
...
// Export
const outputPath = 'F:\\gpt_crazy_vast\\data\\migration_transformed_final.json';
...
console.log('='.repeat(80));
console.log('\nNext: Update mapping UUID promotor & toko di generate_sql.js');
